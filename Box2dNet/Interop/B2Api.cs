// Generated by Box2dWrap for Box2D v3 on 28/12/2024 10:50:49
...
public  partial struct b2CastOutput
{
  ...
  public b2CastOutput(in Vector2 normal, in Vector2 point, in float fraction, in int iterations, in bool hit)
  {
    this.normal = normal;
    this.point = point;
...
public  partial struct b2DistanceOutput
{
  ...
  public b2DistanceOutput(in Vector2 pointA, in Vector2 pointB, in float distance, in int iterations, in int simplexCount)
  {
    this.pointA = pointA;
    this.pointB = pointB;
...
public  partial struct b2ShapeCastPairInput
{
  ...
  public b2ShapeCastPairInput(in b2ShapeProxy proxyA, in b2ShapeProxy proxyB, in b2Transform transformA, in b2Transform transformB, in Vector2 translationB, in float maxFraction)
  {
    this.proxyA = proxyA;
    this.proxyB = proxyB;
    this.transformA = transformA;
...
public  partial struct b2TOIOutput
{
  ...
  public b2TOIOutput(in b2TOIState state, in float fraction)
  {
    this.state = state;
    this.fraction = fraction;
  }
...
public  partial struct b2ManifoldPoint
{
  ...
  public b2ManifoldPoint(in Vector2 point, in Vector2 anchorA, in Vector2 anchorB, in float separation, in float normalImpulse, in float tangentImpulse, in float maxNormalImpulse, in float normalVelocity, in ushort id, in bool persisted)
  {
    this.point = point;
    ...
    this.maxNormalImpulse = maxNormalImpulse;
...
public  partial struct b2WorldId
{
  ...
  public b2WorldId(in ushort index1, in ushort revision)
  {
    this.index1 = index1;
    this.revision = revision;
  }
...
public  partial struct b2BodyId
{
  ...
  public b2BodyId(in int index1, in ushort world0, in ushort revision)
  {
    this.index1 = index1;
    this.world0 = world0;
    this.revision = revision;
...
public  partial struct b2ShapeId
{
  ...
  public b2ShapeId(in int index1, in ushort world0, in ushort revision)
  {
    this.index1 = index1;
    this.world0 = world0;
    this.revision = revision;
...
public  partial struct b2ChainId
{
  ...
  public b2ChainId(in int index1, in ushort world0, in ushort revision)
  {
    this.index1 = index1;
    this.world0 = world0;
    this.revision = revision;
...
public  partial struct b2JointId
{
  ...
  public b2JointId(in int index1, in ushort world0, in ushort revision)
  {
    this.index1 = index1;
    this.world0 = world0;
    this.revision = revision;
...
public  partial struct b2WorldDef
{
  ...
  public b2WorldDef(in Vector2 gravity, in float restitutionThreshold, in float contactPushSpeed, in float hitEventThreshold, in float contactHertz, in float contactDampingRatio, in float jointHertz, in float jointDampingRatio, in float maximumLinearSpeed, in b2MixingRule frictionMixingRule, in b2MixingRule restitutionMixingRule, in bool enableSleep, in bool enableContinuous, in int workerCount, in IntPtr /* b2EnqueueTaskCallback */ enqueueTask, in IntPtr /* b2FinishTaskCallback */ finishTask, in IntPtr /* void* */ userTaskContext, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.gravity = gravity;
    this.restitutionThreshold = restitutionThreshold;
    this.contactPushSpeed = contactPushSpeed;
    this.hitEventThreshold = hitEventThreshold;
    this.contactHertz = contactHertz;
    this.contactDampingRatio = contactDampingRatio;
    this.jointHertz = jointHertz;
    this.jointDampingRatio = jointDampingRatio;
    this.maximumLinearSpeed = maximumLinearSpeed;
    this.frictionMixingRule = frictionMixingRule;
    this.restitutionMixingRule = restitutionMixingRule;
...
public  partial struct b2BodyDef
{
  ...
  public b2BodyDef(in b2BodyType type, in Vector2 position, in b2Rot rotation, in Vector2 linearVelocity, in float angularVelocity, in float linearDamping, in float angularDamping, in float gravityScale, in float sleepThreshold, in IntPtr /* void* */ userData, in bool enableSleep, in bool isAwake, in bool fixedRotation, in bool isBullet, in bool isEnabled, in bool allowFastRotation, in int internalValue)
  {
    this.type = type;
    ...
    this.allowFastRotation = allowFastRotation;
    this.internalValue = internalValue;
  }
...
public  partial struct b2Filter
{
  ...
  public b2Filter(in UInt64 categoryBits, in UInt64 maskBits, in int groupIndex)
  {
...
public  partial struct b2QueryFilter
{
  ...
  public b2QueryFilter(in UInt64 categoryBits, in UInt64 maskBits)
  {
    this.categoryBits = categoryBits;
    this.maskBits = maskBits;
  }
...
public  partial struct b2ShapeDef
{
  ...
  public b2ShapeDef(in IntPtr /* void* */ userData, in float friction, in float restitution, in float rollingResistance, in float density, in b2Filter filter, in uint customColor, in bool isSensor, in bool enableSensorEvents, in bool enableContactEvents, in bool enableHitEvents, in bool enablePreSolveEvents, in bool invokeContactCreation, in bool updateBodyMass, in int internalValue)
  {
    this.userData = userData;
    ...
    this.enablePreSolveEvents = enablePreSolveEvents;
    this.invokeContactCreation = invokeContactCreation;
    this.updateBodyMass = updateBodyMass;
    this.internalValue = internalValue;
  }
...
public  partial struct b2ChainDef
{
  ...
  public b2ChainDef(in IntPtr /* void* */ userData, in IntPtr /* const b2Vec2* */ points, in int count, in float friction, in float restitution, in b2Filter filter, in uint customColor, in bool isLoop, in int internalValue)
  {
    this.userData = userData;
    this.points = points;
    this.count = count;
...
public  partial struct b2Profile
{
  ...
  public b2Profile(in float step, in float pairs, in float collide, in float solve, in float buildIslands, in float solveConstraints, in float prepareTasks, in float solverTasks, in float prepareConstraints, in float integrateVelocities, in float warmStart, in float solveVelocities, in float integratePositions, in float relaxVelocities, in float applyRestitution, in float storeImpulses, in float finalizeBodies, in float splitIslands, in float sleepIslands, in float hitEvents, in float broadphase, in float continuous)
  {
    this.step = step;
    this.pairs = pairs;
    this.collide = collide;
    this.solve = solve;
    this.buildIslands = buildIslands;
    this.solveConstraints = solveConstraints;
    this.prepareTasks = prepareTasks;
    this.solverTasks = solverTasks;
    this.prepareConstraints = prepareConstraints;
    this.integrateVelocities = integrateVelocities;
    this.warmStart = warmStart;
    this.solveVelocities = solveVelocities;
    this.integratePositions = integratePositions;
    this.relaxVelocities = relaxVelocities;
    this.applyRestitution = applyRestitution;
    this.storeImpulses = storeImpulses;
    this.finalizeBodies = finalizeBodies;
...
public  partial struct b2DistanceJointDef
{
  ...
  public b2DistanceJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 localAnchorA, in Vector2 localAnchorB, in float length, in bool enableSpring, in float hertz, in float dampingRatio, in bool enableLimit, in float minLength, in float maxLength, in bool enableMotor, in float maxMotorForce, in float motorSpeed, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
...
public  partial struct b2MotorJointDef
{
  ...
  public b2MotorJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 linearOffset, in float angularOffset, in float maxForce, in float maxTorque, in float correctionFactor, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
...
public  partial struct b2MouseJointDef
{
  ...
  public b2MouseJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 target, in float hertz, in float dampingRatio, in float maxForce, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.target = target;
...
public  partial struct b2NullJointDef
{
  ...
  public b2NullJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.userData = userData;
...
public  partial struct b2PrismaticJointDef
{
  ...
  public b2PrismaticJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 localAnchorA, in Vector2 localAnchorB, in Vector2 localAxisA, in float referenceAngle, in bool enableSpring, in float hertz, in float dampingRatio, in bool enableLimit, in float lowerTranslation, in float upperTranslation, in bool enableMotor, in float maxMotorForce, in float motorSpeed, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.localAnchorA = localAnchorA;
...
public  partial struct b2RevoluteJointDef
{
  ...
  public b2RevoluteJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 localAnchorA, in Vector2 localAnchorB, in float referenceAngle, in bool enableSpring, in float hertz, in float dampingRatio, in bool enableLimit, in float lowerAngle, in float upperAngle, in bool enableMotor, in float maxMotorTorque, in float motorSpeed, in float drawSize, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.localAnchorA = localAnchorA;
...
public  partial struct b2WeldJointDef
{
  ...
  public b2WeldJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 localAnchorA, in Vector2 localAnchorB, in float referenceAngle, in float linearHertz, in float angularHertz, in float linearDampingRatio, in float angularDampingRatio, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.localAnchorA = localAnchorA;
...
public  partial struct b2WheelJointDef
{
  ...
  public b2WheelJointDef(in b2BodyId bodyIdA, in b2BodyId bodyIdB, in Vector2 localAnchorA, in Vector2 localAnchorB, in Vector2 localAxisA, in bool enableSpring, in float hertz, in float dampingRatio, in bool enableLimit, in float lowerTranslation, in float upperTranslation, in bool enableMotor, in float maxMotorTorque, in float motorSpeed, in bool collideConnected, in IntPtr /* void* */ userData, in int internalValue)
  {
    this.bodyIdA = bodyIdA;
    this.bodyIdB = bodyIdB;
    this.localAnchorA = localAnchorA;
...
public  partial struct b2ExplosionDef
{
  ...
  public b2ExplosionDef(in UInt64 maskBits, in Vector2 position, in float radius, in float falloff, in float impulsePerLength)
  {
    this.maskBits = maskBits;
    this.position = position;
    this.radius = radius;
...
public  partial struct b2SensorEvents
{
  ...
  public b2SensorEvents(in IntPtr /* b2SensorBeginTouchEvent* */ beginEvents, in IntPtr /* b2SensorEndTouchEvent* */ endEvents, in int beginCount, in int endCount)
  {
...
public  partial struct b2ContactBeginTouchEvent
{
  ...
  public b2ContactBeginTouchEvent(in b2ShapeId shapeIdA, in b2ShapeId shapeIdB, in b2Manifold manifold)
  {
...
public  partial struct b2ContactEndTouchEvent
{
  ...
  public b2ContactEndTouchEvent(in b2ShapeId shapeIdA, in b2ShapeId shapeIdB)
  {
    this.shapeIdA = shapeIdA;
    this.shapeIdB = shapeIdB;
  }
...
public  partial struct b2ContactEvents
{
  ...
  public b2ContactEvents(in IntPtr /* b2ContactBeginTouchEvent* */ beginEvents, in IntPtr /* b2ContactEndTouchEvent* */ endEvents, in IntPtr /* b2ContactHitEvent* */ hitEvents, in int beginCount, in int endCount, in int hitCount)
  {
    this.beginEvents = beginEvents;
    this.endEvents = endEvents;
    this.hitEvents = hitEvents;
...
public  partial struct b2BodyMoveEvent
{
  ...
  public b2BodyMoveEvent(in b2Transform transform, in b2BodyId bodyId, in IntPtr /* void* */ userData, in bool fellAsleep)
  {
...
public  partial struct b2BodyEvents
{
  ...
  public b2BodyEvents(in IntPtr /* b2BodyMoveEvent* */ moveEvents, in int moveCount)
  {
...
public  partial struct b2ContactData
{
  ...
  public b2ContactData(in b2ShapeId shapeIdA, in b2ShapeId shapeIdB, in b2Manifold manifold)
  {
    this.shapeIdA = shapeIdA;
    this.shapeIdB = shapeIdB;
    this.manifold = manifold;
...
public static extern bool b2Body_IsBullet(b2BodyId bodyId);
  ...
  /// </summary>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern void b2Body_EnableSensorEvents(b2BodyId bodyId, [MarshalAs(UnmanagedType.U1)] bool flag);
...
public static extern int b2Shape_GetSensorCapacity(b2ShapeId shapeId);
  ...
  /// </summary>
  /// <param name="shapeId">the id of a sensor shape</param>
  /// <param name="overlappedShapes">a user allocated array that is filled with the overlapping shapes</param>
  /// <param name="capacity">the capacity of overlappedShapes</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern int b2Shape_GetSensorOverlaps(b2ShapeId shapeId, ref b2ShapeId overlappedShapes, int capacity);
...
public static extern b2SegmentDistanceResult b2SegmentDistance(Vector2 p1, Vector2 q1, Vector2 p2, Vector2 q2);
  ...
  /// </summary>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2DistanceOutput b2ShapeDistance(ref b2SimplexCache cache, in b2DistanceInput input, ref b2Simplex simplexes, int simplexCapacity);
...
public static extern b2CastOutput b2ShapeCast(in b2ShapeCastPairInput input);
  ...
  /// </summary>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2ShapeProxy b2MakeProxy(Vector2[] /* const b2Vec2* */ vertices, int count, float radius);
