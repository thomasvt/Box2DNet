// Generated by Box2dWrap for Box2D v3 on 2/25/2025 9:58:11 AM
...
public enum b2HexColor
{
  ...
  /// <param name="userData">(Original C type: int)</param>
  ...
  /// <param name="materialA">(Original C type: int)</param>
  /// <param name="frictionB">(Original C type: float)</param>
  /// <param name="materialB">(Original C type: int)</param>
  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
...
public  partial struct b2SurfaceMaterial
{
  ...
  public b2SurfaceMaterial(in float friction, in float restitution, in float rollingResistance, in float tangentSpeed, in int material, in uint customColor)
  {
...
public static extern b2Version b2GetVersion();
  ...
  /// <returns>Original C type: uint64_t</returns>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern UInt64 b2GetTicks();
...
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern float b2GetMilliseconds(UInt64 ticks);
...
public static extern int b2Shape_GetSensorCapacity(b2ShapeId shapeId);
  ...
  /// <param name="shapeId">the id of a sensor shape
  /// (Original C type: b2ShapeId)</param>
  /// <param name="overlaps">a user allocated array that is filled with the overlapping shapes
  /// (Original C type: b2ShapeId*)</param>
