// Generated by Box2dWrap for Box2D v3 on 29/12/2024 17:10:16
...
public enum b2HexColor
{
  ...
  /// <param name="proxyId">(Original C type: int32_t)</param>
  /// <param name="userData">(Original C type: int32_t)</param>
  ...
  /// </summary>
  /// <returns>Original C type: void</returns>
  /// <param name="startIndex">(Original C type: int32_t)</param>
  /// <param name="endIndex">(Original C type: int32_t)</param>
  ...
  /// <param name="itemCount">(Original C type: int32_t)</param>
  /// <param name="minRange">(Original C type: int32_t)</param>
  /// <param name="taskContext">(Original C type: void*)</param>
  ...
  /// <param name="shapeIdA">(Original C type: b2ShapeId)</param>
  /// <param name="shapeIdB">(Original C type: b2ShapeId)</param>
  /// <param name="manifold">(Original C type: b2Manifold*)</param>
  /// <param name="context">(Original C type: void*)</param>
  [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
  ...
  /// (Original C type: b2Vec2)</param>
  /// <param name="fraction">the fraction along the ray at the point of intersection
...
public  partial struct b2WorldDef
{
  ...
  /// </summary>
  /// <returns>Original C type: b2MixingRule</returns>
...
public static extern b2Version b2GetVersion();
  ...
  /// <returns>Original C type: void</returns>
  /// <param name="milliseconds">(Original C type: int)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
public static extern b2TreeStats b2World_OverlapAABB(b2WorldId worldId, b2AABB aabb, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_OverlapPoint(b2WorldId worldId, Vector2 point, b2Transform transform, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_OverlapCircle(b2WorldId worldId, in b2Circle circle, b2Transform transform, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_OverlapCapsule(b2WorldId worldId, in b2Capsule capsule, b2Transform transform, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_OverlapPolygon(b2WorldId worldId, in b2Polygon polygon, b2Transform transform, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
...
public static extern b2RayResult b2World_CastRayClosest(b2WorldId worldId, Vector2 origin, Vector2 translation, b2QueryFilter filter);
  ...
  /// <param name="worldId">(Original C type: b2WorldId)</param>
  /// <param name="circle">(Original C type: const b2Circle*)</param>
  /// <param name="originTransform">(Original C type: b2Transform)</param>
  /// <param name="translation">(Original C type: b2Vec2)</param>
  /// <param name="filter">(Original C type: b2QueryFilter)</param>
  /// <param name="fcn">(Original C type: b2CastResultFcn*)</param>
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_CastCircle(b2WorldId worldId, in b2Circle circle, b2Transform originTransform, Vector2 translation, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_CastCapsule(b2WorldId worldId, in b2Capsule capsule, b2Transform originTransform, Vector2 translation, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
  ...
  /// <param name="context">(Original C type: void*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2TreeStats b2World_CastPolygon(b2WorldId worldId, in b2Polygon polygon, b2Transform originTransform, Vector2 translation, b2QueryFilter filter, IntPtr fcn, IntPtr /* void* */ context);
...
public static extern int b2Shape_GetSensorCapacity(b2ShapeId shapeId);
  ...
  /// <param name="shapeId">the id of a sensor shape
  /// (Original C type: b2ShapeId)</param>
  /// <param name="overlappedShapes">a user allocated array that is filled with the overlapping shapes
  /// (Original C type: b2ShapeId*)</param>
  ...
  /// (Original C type: int)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern int b2Shape_GetSensorOverlaps(b2ShapeId shapeId, b2ShapeId[] overlappedShapes, int capacity);
...
public static extern b2JointId b2CreateMotorJoint(b2WorldId worldId, in b2MotorJointDef def);
  ...
  /// <returns>Original C type: void</returns>
  /// <param name="jointId">(Original C type: b2JointId)</param>
  /// <param name="linearOffset">(Original C type: b2Vec2)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
public static extern Vector2 b2MotorJoint_GetLinearOffset(b2JointId jointId);
  ...
  /// <returns>Original C type: void</returns>
  /// <param name="jointId">(Original C type: b2JointId)</param>
  /// <param name="angularOffset">(Original C type: float)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
public static extern float b2MouseJoint_GetMaxForce(b2JointId jointId);
  ...
  /// <returns>Original C type: b2JointId</returns>
  /// <param name="worldId">(Original C type: b2WorldId)</param>
  /// <param name="def">(Original C type: const b2NullJointDef*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
public static extern float b2WeldJoint_GetReferenceAngle(b2JointId jointId);
  ...
  /// <returns>Original C type: void</returns>
  /// <param name="jointId">(Original C type: b2JointId)</param>
  /// <param name="angleInRadians">(Original C type: float)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
public static extern b2CastOutput b2ShapeCastPolygon(in b2ShapeCastInput input, in b2Polygon shape);
  ...
  /// <param name="count">(Original C type: int32_t)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
...
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2DistanceOutput b2ShapeDistance(ref b2SimplexCache cache, in b2DistanceInput input, b2Simplex[] simplexes, int simplexCapacity);
...
public static extern b2CastOutput b2ShapeCast(in b2ShapeCastPairInput input);
  ...
  /// <param name="radius">(Original C type: float)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2ShapeProxy b2MakeProxy(Vector2[] vertices, int count, float radius);
...
public static extern b2MouseJointDef b2DefaultMouseJointDef();
  ...
  /// @ingroup null_joint
  /// </summary>
  /// <returns>Original C type: b2NullJointDef</returns>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
