// Generated by Box2dNetGen for Box2D v3 on 04/05/2025 09:56:03
...
public  partial struct b2PlaneResult
{
  ...
  public b2PlaneResult(in b2Plane plane, in bool hit)
  {
    this.plane = plane;
    this.hit = hit;
  }
...
public  partial struct b2PlaneSolverResult
{
  ...
  public b2PlaneSolverResult(in Vector2 position, in int iterationCount)
  {
...
public static extern float b2GetMilliseconds(ulong ticks);
  ...
  /// <param name="ticks">(Original C type: uint64_t*)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern float b2GetMillisecondsAndReset(IntPtr /* uint64_t* */ ticks);
...
public static extern b2Manifold b2CollideChainSegmentAndPolygon(in b2ChainSegment segmentA, b2Transform xfA, in b2Polygon polygonB, b2Transform xfB, ref b2SimplexCache cache);
  ...
  /// <param name="position">this must be the position used to generate the collision planes
  /// (Original C type: b2Vec2)</param>
  ...
  /// (Original C type: int)</param>
[DllImport(Box2DLibrary, CallingConvention = CallingConvention.Cdecl)]
public static extern b2PlaneSolverResult b2SolvePlanes(Vector2 position, b2CollisionPlane[] planes, int count);
